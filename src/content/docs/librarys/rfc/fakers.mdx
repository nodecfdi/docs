...
Es común usar generadores (ficticios) de datos, esta librería provee la clase `RfcFaker` que se
...
Para crear una cadena de caracteres para una clave RFC de una persona física (13 posiciones),
usaremos el método a continuación:
...
Para crear una cadena de caracteres para una clave RFC de una persona moral (12 posiciones),
usaremos el método a continuación:
...
Para crear una cadena de caracters para una clave RFC indistinta de una persona moral o física,
usaremos el método a continuación:
